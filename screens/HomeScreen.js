...
setCarregando(true);
try {
const response = await fetch('https://raw.githubusercontent.com/cachorrinho12/reposit-rio/refs/heads/main/receitas.json');
